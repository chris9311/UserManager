...
tape('do not mutate schemas', function(t) {
  var sch = {
    items: [
      {}
    ],
...
tape('#toJSON()', function(t) {
  ...
  t.deepEqual(validate.toJSON(), schema, 'should return original schemas')
  t.end()
})
...
tape('top-level external schemas', function(t) {
  var defs = {
    "string": {
      type: "string"
    },
  ...
  t.notOk(validate({name:"alice", sex: "bob"}), 'recognizes external schemas')
  t.notOk(validate({name:2, sex: "female"}), 'recognizes external schemas')
  t.end()
})
