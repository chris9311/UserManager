 ...
 *     var Product = db.models('Product', schemas);
 *
 ...
 *     })
 *
 * For legacy reasons, mongoose stores object keys in reverse order on initial save. That is, `{ a: 1, b: 2 }` will be saved as `{ b: 2, a: 1 }` in MongoDB. To override this behavior, set [the `toObject.retainKeyOrder` option](http://mongoosejs.com/docs/api.html#document_Document-toObject) to true on your schemas.
 *
 * @param {Object} [options] options set `options.safe` to override [schemas's safe option](http://mongoosejs.com//docs/guide.html#safe)
